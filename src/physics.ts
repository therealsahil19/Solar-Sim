...
export function getOrbitalPosition(
    ...
    // Optimization: Use a better initial guess (E = M + e * sin(M)) for faster convergence.
    // This typically saves 1-2 iterations compared to E=M, especially for high eccentricity.
